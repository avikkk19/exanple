...
export const BottomLine = () => {
  return (
    <>
      <div className="hidden absolute top-[50.1rem] left-10 right-10 h-0.25 bg-n-6 pointer-events-none xl:block" />

      <PlusSvg className="hidden absolute top-[49.8rem] left-[2.1875rem] z-2 pointer-events-none xl:block" />

      <PlusSvg className="hidden absolute top-[49.8rem] right-[2.1875rem] z-2 pointer-events-none xl:block" />
    </>
  );
};
